...
const PaymentSuccessPage = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-50">
      <Navbar/>
      <div className="bg-white p-8 md:p-10 shadow-lg rounded-xl text-center max-w-lg">
        <svg
          viewBox="0 0 24 24"
        ...
        <div className="mt-6 text-2xl font-bold text-gray-900">Payment Successful!</div>
        ...
        {amount && (
          <div className="mt-6 text-lg font-semibold text-green-700">
            You paid <span className="font-bold text-2xl">₹{Math.floor(parseFloat(amount))}</span>
          </div>
        )}
        {eta && (
          <div className="mt-4 text-lg text-gray-600">
            Your cab will arrive in <span className="font-semibold">{eta} min</span>.
          </div>
        )}
